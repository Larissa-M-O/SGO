...
export default function LayoutLateral() {
  ...
  return (
    <div className="d-flex flex-column p-3 sidebar">
      ...
      <Link href={`/engenheiro/${usuario.id}/cronogramas`} className={itemClass("/cronogramas")}>
      ...
      {submenuAberto && (
        <div className="sidebar-submenu">
          <Link href={`/engenheiro/${usuario.id}/obras`} className={itemClass("/obras")}>
            <Icon src="/icons/obras.png" />
            Obras
          </Link>

          <Link href={`/engenheiro/${usuario.id}/recursos`} className={itemClass("/recursos")}>
      ...
      <Link href={`/engenheiro/${usuario.id}/orcamentos`} className={itemClass("/orcamentos")}>
        <Icon src="/icons/orcamentos.png" />
        Orçamentos
      </Link>

      <Link href={`/engenheiro/${usuario.id}/relatorios`} className={itemClass("/relatorios")}>
      ...
      <div className="mt-auto text-white">
        ...
        <div className="d-flex align-items-center gap-2">
          <img
            ...
            alt="user"
          />
          <div onClick={() => router.push(`/engenheiro/${usuario.id}/usuarios/usuario-visualizar`)}>
