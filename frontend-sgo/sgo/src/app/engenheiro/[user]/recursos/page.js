  ...
  return (
    <div className="container-recursos">
      ...
      <div className="topo-recursos">
        ...
        <button className="btn-novo" onClick={() => router.push(`/engenheiro/${user}/recursos/recurso-cadastrar`)}>+ Novo Recurso</button>
      </div>
      ...
      {recursos.map((r) => (
        <div key={r.idRecurso} className="card-recurso">
          ...
          <div className="acoes">
            <button className="btn-editar" onClick={() => router.push(`/engenheiro/${user}/recursos/recurso-editar/${r.idRecurso}`)}>Alterar</button>
            <button
